...
- Every call runs in a fresh shell: environment variables, `cd`, and history do not carry over between calls.
- Put related work in one call with `&&`, `;`, `||`, pipes, redirects, and control flow, rather than making several.
